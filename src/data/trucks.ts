...
export const trucks: Truck[] = [
  ...
  {
    id: "5",
    slug: "2014-isuzu-fmv-1200",
    title: "2014 Isuzu FMV 1200",
    make: "Isuzu",
    model: "FMV 1200",
    year: 2014,
    category: "Tipper",
    ...
    mileage: 684937,
    images: [
      "/images/trucks/isuzu-fmv-1200-2014/01-front-angle.png",
      "/images/trucks/isuzu-fmv-1200-2014/02-side-profile.png",
      "/images/trucks/isuzu-fmv-1200-2014/03-rear-angle.png",
      "/images/trucks/isuzu-fmv-1200-2014/04-cab-interior.png",
      "/images/trucks/isuzu-fmv-1200-2014/05-compliance-plate.png",
      "/images/trucks/isuzu-fmv-1200-2014/06-interior-odometer.png",
    ],
    featured: true,
    status: "available",
    hideCategory: true,
    description:
      "2014 Isuzu FMV 1200 tipper with white cab and grey tipper body with wooden side boards. Hydraulic tipper unit in good working condition, ideal for construction, mining, and bulk material transport. Inspected and ready for immediate deployment.",
    specs: {
      engine: "6HK1-TCC 7790cc Turbo Diesel",
      transmission: "Manual 6-Speed",
      axles: "4x2",
